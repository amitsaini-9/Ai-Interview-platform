        ...
        <div className="relative mx-auto mt-16 max-w-4xl">
          <div className="overflow-hidden rounded-2xl border border-border bg-surface shadow-2xl shadow-primary/5">
            ...
            <div className="flex items-center gap-2 border-b border-border px-4 py-3">
              ...
              <span className="ml-3 text-xs text-muted">AI Interview Session</span>
            </div>
    ...
    <section id="features" className="relative py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-semibold tracking-wide text-primary">WHY AI INTERVIEW</p>
...
const testimonials = [
  {
    ...
    content:
      "AI Interview helped me practice system design and React questions. The AI felt like a real interviewer. I cracked my Google interview on the first try!",
    rating: 5,
  },
  {
    name: "Rahul Mehta",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-accent to-primary-dark px-6 py-16 text-center sm:px-16 sm:py-24">
          ...
          <p className="relative mx-auto mt-4 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg">
            ...
            AI Interview. Start practicing for free — no credit card required.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-1">
            <a href="/" className="flex items-center gap-2" aria-label="AI Interview Home">
